...
def draw_menu(screen, font, title_font, btn_rect):
    ...
    # Dark navy-to-indigo gradient background
    for y in range(h):
        ratio = y / h
        r = int(10 + ratio * 8)
        g = int(10 + ratio * 6)
    ...
    # Animated ambient glow behind title
